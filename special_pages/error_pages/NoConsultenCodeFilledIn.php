...
<div class="lists">
    ...
    <section class="content">
        ...
        <h1>De gebruiker of het paswoord zijn incorrect, of er was een databank fout!</h1>

        <h3 style="margin: 0 auto; text-align: center;">Als deze fout zich blijft voordoen, gelieve Nick Jorens te
            contacteren!</h3>
